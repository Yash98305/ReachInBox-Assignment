...
const ToggleButton = () => {
  ...
  return  (
    <label>
      <div
        style={{
          border: `1px solid ${checked ? "#DADEE1" : "#343A40"}`, // Add the border here
          borderRadius: "16px", // Optional, to round the edges
          display: "inline-block", // Ensure the div wraps around the switch
        }}
      >
      ...
      handleDiameter = {20}
        ...
        checked={checked}
        offHandleColor="#888686"
        offColor="#222426" // Light background when unchecked
        onColor="#E9EAEC" // Dark background when checked
...
<path d="M5.0275 2.1325C4.8925 2.6125 4.825 3.115 4.825 3.625C4.825 6.685 7.315 9.175 10.375 9.175C10.885 9.175 11.3875 9.1075 11.8675 8.9725C11.0875 10.8925 9.1975 12.25 7 12.25C4.105 12.25 1.75 9.895 1.75 7C1.75 4.8025 3.1075 2.9125 5.0275 2.1325ZM7 0.25C3.2725 0.25 0.25 3.2725 0.25 7C0.25 10.7275 3.2725 13.75 7 13.75C10.7275 13.75 13.75 10.7275 13.75 7C13.75 6.655 13.72 6.31 13.675 5.98C12.94 7.0075 11.74 7.675 10.375 7.675C8.14 7.675 6.325 5.86 6.325 3.625C6.325 2.2675 6.9925 1.06 8.02 0.325C7.69 0.28 7.345 0.25 7 0.25Z" fill="#E8C364"/>
</svg>
