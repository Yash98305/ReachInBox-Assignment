...
import MailDarkLogo from "./svg/MailDarkLogo";
import MailLightLogo from "./svg/MailLightLogo";
...
borderRadius: "2px"
      ...
      }}>{theme === "light"?<MailLightLogo/>:<MailDarkLogo/>}
      </div>
      <ul style={{
        listStyle : "none",
        display : "flex",
flexDirection:"column",
      ...
      <Avatar sx={{ width: 35, height: 35,mb:3 }} alt="Remy Sharp" src="/static/images/avatar/1.jpg" />
    </div>
  );
};
